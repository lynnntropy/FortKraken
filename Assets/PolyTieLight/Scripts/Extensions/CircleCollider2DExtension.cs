...
public static class CircleCollider2DExtension
{
    ...
    {
        return circle.transform.position + new Vector3(circle.center.x, circle.center.y, 0);
    }

    public static void SetWorldCenter(this CircleCollider2D circle, Vector3 position)
    {
        circle.transform.position = position - new Vector3(circle.center.x, circle.center.y, 0);
    }
}
